...
public class ImGuiController : IDisposable
{
    ...
    public static Vector4 highlightColor = new Vector4(.7f, .2f, 1f, 1);
    ...
    public static void SetupImGuiStyle()
    {
        ...
        style.Colors[(int)ImGuiCol.TabDimmedSelected] = new Vector4(0.0f, 0.4509803950786591f, 1.0f, 0.0f);
        style.Colors[(int)ImGuiCol.TabDimmed] = new Vector4(0.1333333402872086f, 0.2588235437870026f, 0.4235294163227081f, 0.0f);
    ...
    {
        Vector4 darkColor = new Vector4(.01f, .01f, .01f, 1);
        ...
        colors[(int)ImGuiCol.DockingEmptyBg] = new Vector4(0.05f, 0.05f, 0.05f, 0.54f);
        colors[(int)ImGuiCol.DockingPreview] = new Vector4(0.05f, 0.05f, 0.05f, 0.54f);
        ...
        colors[(int)ImGuiCol.MenuBarBg] = new Vector4(0.05f, 0.05f, 0.05f, 1.00f);
        ...
        colors[(int)ImGuiCol.TabDimmedSelected] = new Vector4(0.20f, 0.20f, 0.20f, 0.36f);
        colors[(int)ImGuiCol.TabDimmedSelectedOverline] = new Vector4(0f, 0, 0, 1.00f);
        colors[(int)ImGuiCol.TabSelected] = new Vector4(0.14f, 0.14f, 0.14f, 1.00f);
        colors[(int)ImGuiCol.TabSelectedOverline] = new Vector4(0.00f, 0.00f, 0.00f, 0.52f);
