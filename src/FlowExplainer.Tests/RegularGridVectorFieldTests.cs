...
public class RegularGridVectorFieldTests
{
    ...
    public void RegularGridVectorField2DTest()
    {
        ...
        Assert.Equal(0, grid.DataGrid.GetCoordsIndex(new Vec2i(0, 0)));
        Assert.Equal(1, grid.DataGrid.GetCoordsIndex(new Vec2i(1, 0)));
        Assert.Equal(2, grid.DataGrid.GetCoordsIndex(new Vec2i(0, 1)));
        Assert.Equal(3, grid.DataGrid.GetCoordsIndex(new Vec2i(1, 1)));
